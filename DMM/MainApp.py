...
class Ui_DMMMainUI(object):
    def setupUi(self, DMMMainUI):
        ...
        self.label_TimeNow.setGeometry(QtCore.QRect(10, 10, 350, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.label_TimeNow.setFont(font)
        self.label_TimeNow.setAutoFillBackground(False)
        self.label_TimeNow.setStyleSheet("border:none;\n"
                                         "color:rgb(167,167,102);")
        self.label_TimeNow.setScaledContents(True)
        self.label_TimeNow.setWordWrap(True)
        self.label_TimeNow.setObjectName("label_TimeNow")
        self.label_Weight = QtWidgets.QLabel(self.MainFrame)
        self.label_Weight.setGeometry(QtCore.QRect(10, 55, 440, 151))
        ...
        self.label_Weight.setScaledContents(True)
        self.label_Weight.setWordWrap(True)
        ...
        self.label_QRCode.setAutoFillBackground(False)
        ...
        self.widget_FloatFrame4.setGeometry(QtCore.QRect(458, 290, 215, 80))
        ...
        self.label_OpID.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.widget_FloatFrame3.setGeometry(QtCore.QRect(458, 207, 215, 80))
        ...
        self.label_DocID.setStyleSheet("border:none;\n"
                                       "color:#FFE41E;\n"
                                       "background-color:#17202A;")
        self.label_DocID.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.label_TruckID.setGeometry(QtCore.QRect(460, 10, 140, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.label_TruckID.setFont(font)
        self.label_TruckID.setAutoFillBackground(False)
        self.label_TruckID.setStyleSheet("border:none;\n"
                                         "color:rgb(236, 112, 99 );")
        self.label_TruckID.setScaledContents(True)
        self.label_TruckID.setWordWrap(True)
        self.label_TruckID.setObjectName("label_TruckID")
        self.label_TruckIDIcon = QtWidgets.QLabel(self.MainFrame)
        self.label_TruckIDIcon.setGeometry(QtCore.QRect(420, 15, 34, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.widget_FloatFrame1.setGeometry(QtCore.QRect(458, 40, 215, 80))
        ...
        self.label_DocID_2.setStyleSheet("border:none;\n"
                                         "color:#FFE41E;\n"
                                         "background-color:#17202A;")
        self.label_DocID_2.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.widget_FloatFrame2.setGeometry(QtCore.QRect(458, 124, 215, 80))
        ...
        self.label_DocID_6.setStyleSheet("border:none;\n"
                                         "color:#FFE41E;\n"
                                         "background-color:#17202A;")
        self.label_DocID_6.setAlignment(QtCore.Qt.AlignCenter)
    ...
    def retranslateUi(self, DMMMainUI):
        ...
        self.label_OpID.setText(_translate("DMMMainUI", "WH9963"))
        self.label_7.setText(_translate("DMMMainUI", "OPERATOR ID"))
        self.label_DocID.setText(_translate("DMMMainUI", "WH99632709987/43A"))
        self.label_5.setText(_translate("DMMMainUI", "DOCUMENT ID"))
        self.label_TruckID.setText(_translate("DMMMainUI", "WP-WW1234"))
        self.label_DocID_2.setText(_translate("DMMMainUI", "WH99632709987/43A"))
        self.label_6.setText(_translate("DMMMainUI", "DOCUMENT ID"))
        self.label_DocID_6.setText(_translate("DMMMainUI", "WH99632709987/43A"))
        self.label_11.setText(_translate("DMMMainUI", "DOCUMENT ID"))
    ...
    def formatWindow(self, DMMMainUI):
        ...
        your_ttf_font = QFont("DJB Get Digital", 105)
    ...
    def insertWeightData(self):
        try:
            ...
            if weight > (float)(self.WEIGHTTHRESHOLD):
                ...
                stat = self.WBHelper.insertData(
                    [self.TRUCKID, weight, self.WEIGHTMODE, self.DOCID, self.SERIALMODE, date_time])
                if stat is True:
    ...
    def updateTimeText(self, timestamp):
        self.label_TimeNow.setText(timestamp)
    ...
    def showMainWindowAgain(self, mode):
        DMMMainUI.show()
        if self.OPENKEYBORADACTIONSTAT is True:
            if mode is 'DOC':
                self.widget_FloatFrame3.show()
                self.label_DocID.setText(QtCore.QCoreApplication.translate("DMMMainUI",
                                                                           "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">" + self.DOCID + "</span></p></body></html>"))
    ...
    def actionDocIDScan(self):
        DMMMainUI.hide()
        self.w = KeyboardWidget(title='ENTER or SCAN --> Documentation ID', GUI=self, mode='DOC', scanner=True)
        self.w.show()
